package com.example.headlineshub.ui.home
...
import com.example.headlineshub.ui.components.common.ArticlesList
import com.example.headlineshub.ui.components.common.SearchBar
import com.example.headlineshub.ui.navgraph.Route
import com.example.headlineshub.ui.theme.Dimensions

@OptIn(ExperimentalFoundationApi::class)
@Composable
fun HomeScreen(articles: LazyPagingItems<Article>, navigate: (String) -> Int) {
    val titles by remember {
        derivedStateOf {
            if (articles.itemCount > 0) {
                articles.itemSnapshotList.items.slice(
                    IntRange(start = 0, endInclusive = 10)
    ...
    Column(
        ...
        SearchBar(
            ...
            onValueChange = {},
            onClick = {
                navigate(Route.SearchScreen.name)
            }
        )
        Spacer(modifier = Modifier.height(Dimensions.MediumPadding1))
        Text(
